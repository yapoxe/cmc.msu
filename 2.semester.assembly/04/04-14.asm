...
;Во входном файле input.txt записана последовательность чисел. 
;Числа в последовтельности целые, по модулю не превосходящие 109. Их количество не превышает 4000.
...
;Для хранения последовательности используйте однонаправленный или двунаправленный список.
;Также запрещается использовать макросы ввода-вывода библиотеки io.inc. 
